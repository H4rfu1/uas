  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASEURL; ?>/admin">
        ...
        <div class="sidebar-brand-text mx-3">ADMIN <sup>cardoor</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTables" class="collapse" aria-labelledby="headingTables" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= BASEURL; ?>/admin/user">User</a>
            <a class="collapse-item" href="<?= BASEURL; ?>/admin/pemesanan">Pemesanan</a>
            <a class="collapse-item" href="<?= BASEURL; ?>/admin/kendaraan">Kendaraan</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $data['user']['nm_dpan'].' '.$data['user']['nm_blakang'] ?></span>
                <img class="img-profile rounded-circle" src="<?= BASEURL; ?>/assets/img/profil/<?= $data['user']['image']; ?>">
              </a>
